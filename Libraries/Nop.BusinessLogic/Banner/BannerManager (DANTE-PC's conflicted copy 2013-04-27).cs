...
namespace NopSolutions.NopCommerce.BusinessLogic.Banner
{
    ...
    public partial class BannerManager
    {
        ...
        public static Banner InsertBanner(string BannerName, int PageID, int PictureID, string URL, bool IsPublish, int Views)
        {
            DBBanner dbItem = DBProviderManager<DBBannerProvider>.Provider.InsertBanner(PageID, BannerName, IsPublish, PictureID, URL, Views);
            Banner item = DBMapping(dbItem);
        ...
        public static Banner UpdateBanner(int BannerID, string BannerName, int PageID, int PictureID, string URL, bool IsPublish, int Views)
        {
            DBBanner dbItem = DBProviderManager<DBBannerProvider>.Provider.UpdateBanner(BannerID, PageID, BannerName,
                                                                                        IsPublish, PictureID, URL, Views);
            Banner item = DBMapping(dbItem);
