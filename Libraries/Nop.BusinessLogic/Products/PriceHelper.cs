...
namespace NopSolutions.NopCommerce.BusinessLogic.Products
{
    ...
    public partial class PriceHelper
    {
        ...
        public static string SavePoint(decimal value)
        {
            int devide = int.Parse(ConfigurationManager.AppSettings["SavePointUnit"]);
            decimal point = value/devide;
            return point.ToString("#") == "" ? "0" : point.ToString("#");
        }
