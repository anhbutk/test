...
namespace NopSolutions.NopCommerce.BusinessLogic.Orders
{
    ...
    public partial class Order : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the note of order
        /// </summary>
        ...
        /// <summary>
        /// Get total save point of this customer
        /// </summary>
        public string CustomerSavePoint
        {
            get
            {
                return OrderManager.GetCustomerSavePoint(CustomerID);
            }
        }
        ...
        public PaymentMethod PaymentMethod
        {
            get
            {
                return PaymentMethodManager.GetPaymentMethodByID(PaymentMethodID);
            }
        }
