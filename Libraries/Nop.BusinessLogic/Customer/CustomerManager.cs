...
namespace NopSolutions.NopCommerce.BusinessLogic.CustomerManagement
{
    ...
    public partial class CustomerManager
    {
        ...
        public static void MarkCustomerAsDeleted(int CustomerID)
        {
            ...
            if (customer != null)
            {
                UpdateCustomer(customer.CustomerID, customer.CustomerGUID, customer.Email + "_deleted",
                    customer.Username + "_deleted", customer.PasswordHash, customer.SaltKey,
            ...
            if (!IsGuest)
            {
                ...
                else
                {
                    if (CustomerManager.RegistrationEmailValidation)
                    {
                        ...
                        MessageManager.SendCustomerEmailValidationMessage(customer, NopContext.Current.WorkingLanguage.LanguageID, Password);
                    }
                }
            }
            return customer;
