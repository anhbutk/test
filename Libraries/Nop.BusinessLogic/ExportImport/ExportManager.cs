        ...
        public static void ExportCustomersToXLS(string FilePath, CustomerCollection customers)
        {
            using (ExcelHelper excelHelper = new ExcelHelper(FilePath))
            {
                ...
                foreach (Customer customer in customers)
                {
                    ...
                    sb.Append("INSERT INTO [Customers] (CustomerID, Email, FirstName, LastName, ReceiveNewsletter) VALUES (");
                    ...
                    sb.Append('"'); sb.Append(customer.StreetAddress.Replace('"', '\'')); sb.Append("\",");
