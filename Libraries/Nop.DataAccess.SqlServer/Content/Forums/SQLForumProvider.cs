...
namespace NopSolutions.NopCommerce.DataAccess.Content.Forums
{
    ...
    public partial class SQLForumProvider : DBForumProvider
    {
        ...
        private DBForumTopic GetForumTopicFromReader(IDataReader dataReader)
        {
            ...
            forumTopic.TopicContent = NopSqlDataHelper.GetString(dataReader, "TopicContent");
            forumTopic.VideoClip = NopSqlDataHelper.GetString(dataReader, "VideoClip");
            forumTopic.HomePage = NopSqlDataHelper.GetBoolean(dataReader, "HomePage");
            forumTopic.OnOff = NopSqlDataHelper.GetBoolean(dataReader, "OnOff");
            forumTopic.PictureID = NopSqlDataHelper.GetInt(dataReader, "PictureID");
            forumTopic.ShortContent = NopSqlDataHelper.GetString(dataReader, "ShortContent");
            forumTopic.Position = NopSqlDataHelper.GetInt(dataReader, "Position");
            return forumTopic;
        }
        ...
        public override DBForumCollection GetAllForums()
        {
            DBForumCollection forumCollection = new DBForumCollection();
            Database db = NopSqlDataHelper.CreateConnection(_sqlConnectionString);
            DbCommand dbCommand = db.GetStoredProcCommand("Nop_Forums_ForumLoadAll");
            using (IDataReader dataReader = db.ExecuteReader(dbCommand))
            {
                while (dataReader.Read())
                {
        ...
        public override DBForumTopicCollection GetTopicsByForumID(int ForumID)
        {
            DBForumTopicCollection forumTopicCollection = new DBForumTopicCollection();
            Database db = NopSqlDataHelper.CreateConnection(_sqlConnectionString);
            DbCommand dbCommand = db.GetStoredProcCommand("Nop_Forums_TopicLoadByForumID");
            db.AddInParameter(dbCommand, "ForumID", DbType.Int32, ForumID);
            using (IDataReader dataReader = db.ExecuteReader(dbCommand))
            {
                while (dataReader.Read())
        ...
        public override DBForumTopicCollection GetOlderTopicsByTopicIDForumID(int ForumID, DateTime TopicDate)
        {
            DBForumTopicCollection forumTopicCollection = new DBForumTopicCollection();
            Database db = NopSqlDataHelper.CreateConnection(_sqlConnectionString);
            DbCommand dbCommand = db.GetStoredProcCommand("Nop_Forums_TopicLoadOlderByForumIDTopicID");
            db.AddInParameter(dbCommand, "ForumID", DbType.Int32, ForumID);
            db.AddInParameter(dbCommand, "TopicDate", DbType.DateTime, TopicDate);
            using (IDataReader dataReader = db.ExecuteReader(dbCommand))
            {
                while (dataReader.Read())
                {
        ...
        public override DBForumTopicCollection GetAllTopicsExtreme()
        {
            DBForumTopicCollection forumTopicCollection = new DBForumTopicCollection();
            Database db = NopSqlDataHelper.CreateConnection(_sqlConnectionString);
            DbCommand dbCommand = db.GetStoredProcCommand("Nop_Forums_TopicLoadExtremeAll");
            using (IDataReader dataReader = db.ExecuteReader(dbCommand))
            {
                while (dataReader.Read())
                {
        ...
        public override DBForumTopic InsertTopic(int ForumID, int UserID,
            ...
            DateTime CreatedOn, DateTime UpdatedOn, string TopicContent, string VideoClip,
            bool Homepage, bool OnOff, int PictureID, string ShortContent)
        {
            DBForumTopic forumTopic = null;
            Database db = NopSqlDataHelper.CreateConnection(_sqlConnectionString);
            ...
            db.AddInParameter(dbCommand, "CreatedOn", DbType.DateTime, CreatedOn);
            db.AddInParameter(dbCommand, "UpdatedOn", DbType.DateTime, UpdatedOn);
            db.AddInParameter(dbCommand, "TopicContent", DbType.String, TopicContent);
            db.AddInParameter(dbCommand, "VideoClip", DbType.String, VideoClip);
            db.AddInParameter(dbCommand, "Homepage", DbType.Boolean, Homepage);
            db.AddInParameter(dbCommand, "OnOff", DbType.Boolean, OnOff);
            db.AddInParameter(dbCommand, "PictureID", DbType.Int16, PictureID);
            db.AddInParameter(dbCommand, "ShortContent", DbType.String, ShortContent);
            if (db.ExecuteNonQuery(dbCommand) > 0)
            {
        ...
        public override DBForumTopic UpdateTopic(int ForumTopicID, int ForumID, int UserID,
            ...
            int LastPostUserID, DateTime? LastPostTime,
            DateTime CreatedOn, DateTime UpdatedOn, string TopicContent, string VideoClip,
            bool Homepage, bool OnOff, int PictureID, string ShortContent, int Position)
        {
            DBForumTopic forumTopic = null;
            Database db = NopSqlDataHelper.CreateConnection(_sqlConnectionString);
            ...
            db.AddInParameter(dbCommand, "PictureID", DbType.Int16, PictureID);
            db.AddInParameter(dbCommand, "ShortContent", DbType.String, ShortContent);
            db.AddInParameter(dbCommand, "Position", DbType.Int16, Position);
            if (db.ExecuteNonQuery(dbCommand) > 0)
