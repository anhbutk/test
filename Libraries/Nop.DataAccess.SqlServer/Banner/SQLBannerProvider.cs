...
namespace NopSolutions.NopCommerce.DataAccess.Banner
{
    ...
    public partial class SQLBannerProvider : DBBannerProvider
    {
        ...
        private DBBanner GetBannerFromReader(IDataReader dataReader)
        {
            ...
            item.Position = NopSqlDataHelper.GetInt(dataReader, "Position");
            return item;
        }
        ...
        #region Banner
        public override DBBanner InsertBanner(int PageID, string BannerName, bool IsPublish, int PictureID, string URL, int Views, int Position)
        {
            DBBanner item = null;
            Database db = NopSqlDataHelper.CreateConnection(_sqlConnectionString);
        ...
        public override DBBanner UpdateBanner(int BannerID, int PageID, string BannerName, bool IsPublish, int PictureID, string URL, int Views, int Position)
        {
            DBBanner item = null;
            Database db = NopSqlDataHelper.CreateConnection(_sqlConnectionString);
