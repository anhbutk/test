...
namespace NopSolutions.NopCommerce.DataAccess.Banner
{
    ...
    public abstract partial class DBBannerProvider : BaseDBProvider
    {
        ...
        public abstract DBBanner InsertBanner(int PageID, string BannerName, bool IsPublish, int PictureID, string URL, int Views);

        public abstract DBBannerCollection GetAllBanner();

        public abstract void DeleteBanner(int BannerID);

        public abstract DBBanner UpdateBanner(int BannerID, int PageID, string BannerName, bool IsPublish, int PictureID, string URL, int Views);
