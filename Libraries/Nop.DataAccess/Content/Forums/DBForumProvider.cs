...
namespace NopSolutions.NopCommerce.DataAccess.Content.Forums
{
    ...
    public abstract partial class DBForumProvider : BaseDBProvider
    {
        ...
        public abstract DBForumCollection GetAllForums();
        ...
        public abstract DBForumTopicCollection GetTopicsByForumID(int ForumID);

       // public abstract DBForumTopicCollection GetNewestTopicsHomepage();

        public abstract DBForumTopicCollection GetOlderTopicsByTopicIDForumID(int ForumID, DateTime TopicDate);

        public abstract DBForumTopicCollection GetAllTopicsExtreme();
        ...
        public abstract DBForumTopic InsertTopic(int ForumID, int UserID,
            ...
            DateTime CreatedOn, DateTime UpdatedOn, string TopicContent, string VideoClip, bool Homepage,
            bool OnOff, int PictureID, string ShortContent);
        ...
        public abstract DBForumTopic UpdateTopic(int ForumTopicID, int ForumID, int UserID,
            ...
            int NumPosts, int Views, int LastPostID,
            int LastPostUserID, DateTime? LastPostTime,
            DateTime CreatedOn, DateTime UpdatedOn, string TopicContent,
            string VideoClip, bool Homepage, bool OnOff, int PictureID, string ShortContent, int Position);
