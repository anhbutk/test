<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Templates.Categories.ProductGridPhanNu"
    CodeBehind="ProductGridPhanNu.ascx.cs" %>
...
<div class="CategoryPage">
    <div class="breadcrumb">
        ...
        <asp:Repeater ID="rptrCategoryBreadcrumb" runat="server">
            <ItemTemplate>
                <b><a href='<%#SEOHelper.GetCategoryURL(Convert.ToInt32(Eval("CategoryID"))) %>' title="<%#Eval("Name") %>">
    ...
    <div class="ProductList1">
        <asp:ListView ID="lvCatalog" runat="server">
            ...
            <ItemTemplate>
                <div class="ItemBox">
                    <nopCommerce:ProductBoxPhanNu ID="ctrlProductBox" Product='<%# Container.DataItem %>'
                        runat="server" />
                </div>
            </ItemTemplate>
        </asp:ListView>
    ...
    <div id="phantrangnew">
        <nopCommerce:Pager runat="server" ID="catalogPager" FirstButtonText="<% $NopResources:Pager.First %>"
            ...
            PreviousButtonText="<% $NopResources:Pager.Previous %>" CurrentPageText="Pager.CurrentPage" CssClass="page" />
    </div>
</div>
