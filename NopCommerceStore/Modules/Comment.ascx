<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Modules.CommentControl"
...
<div class="contactform">
    <div>
        <nopCommerce:Topic ID="topicContactUs" runat="server" TopicName="Comment"></nopCommerce:Topic>
    </div>
    <div class="clear">
    </div>
    <asp:Panel runat="server" ID="pnlResult" Visible="false" style="padding-top:15px">
        <strong>
            <%=GetLocaleResourceString("ContactUs.YourCommentEnquiryHasBeenSent")%></strong>
    </asp:Panel>
    <div class="clear">
    </div>
