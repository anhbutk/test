...
<div class="ProductSpecFilter">
    ...
    <asp:Panel runat="server" ID="pnlRemoveFilter" CssClass="RemoveFilter">
        <asp:HyperLink ID="hlRemoveFilter" runat="server" CssClass="RemoveProductSpecFilter">
