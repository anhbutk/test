                        ...
                        <tbody style="text-align: left">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="UserNameOrEmailRequired" runat="server" ControlToValidate="UserName"
                                        ErrorMessage="<% $NopResources:Login.E-MailRequired %>" ToolTip="<% $NopResources:Login.E-MailRequired %>" ValidationGroup="ctl00$LoginForm" Display="Dynamic">*</asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator runat="server" ID="revEmail" ControlToValidate="UserName"
                                            ErrorMessage="<% $NopResources:Account.InvalidEmail %>" ToolTip="<% $NopResources:Account.InvalidEmail %>"  Display="Dynamic" ValidationExpression="[\w\.-]+(\+[\w-]*)?@([\w-]+\.)+[\w-]+"
                                            ValidationGroup="ctl00$LoginForm">*</asp:RegularExpressionValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="Password"
                                        ...
                                        ValidationGroup="ctl00$LoginForm"  Display="Dynamic">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <asp:ValidationSummary ID="ValidationSummary" runat="server" DisplayMode="List" ValidationGroup="ctl00$LoginForm"   />
                                </td>                                
                            </tr>
                            <tr>
                                <td colspan="2">
