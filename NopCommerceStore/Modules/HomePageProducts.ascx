...
<div id="special" style="overflow: hidden; position: relative; width: 1000px;">
    ...
    <a href="#" class="previousButton png" style="background-position: 0 0; left: 23px;
        position: absolute; top: 70px; display: block; height: 40px; width: 22px;" rel="">
        <img src="images/leftscroll.jpg" name="Image22" width="12" height="32" border="0"
            id="Image22" alt="" /></a><a href="#" class="nextButton png" style="background-position: 0 -40px;
                left: 947px; position: absolute; top: 70px; display: block; height: 40px; width: 22px;" rel="">
