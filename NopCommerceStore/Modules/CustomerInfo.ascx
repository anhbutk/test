...
<div style="text-align: left">
    ...
    <div class="SectionTitle">
        <%=GetLocaleResourceString("Order.SavePoint")%>
    </div>
    <div class="clear">
    </div>
    <div class="SectionBody">
            ...
            <table class="TableContainer">
                <tbody>
                    ...
                    <tr class="Row" runat="server" id="trSignature">
                        ...
                        <td class="ItemValue">
                            <asp:TextBox ID="txtSignature" runat="server" TextMode="MultiLine" MaxLength="300"></asp:TextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="Button">
        <asp:Button runat="server" ID="btnSaveCustomerInfo" Text="<% $NopResources:Account.Save %>"
            ValidationGroup="CustomerInfo" OnClick="btnSaveCustomerInfo_Click"></asp:Button>
    </div>
</div>
