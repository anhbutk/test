...
<div id="shoppingcart">
    ...
    <div>
        <div runat="server" id="pnlResult">
            <strong>
                <asp:Literal runat="server" ID="lResult"></asp:Literal>
            </strong>
        </div>
    </div>
    <div runat="server" id="pnlRecover">
        <table>
            <tr>
                <td style="text-align: left; vertical-align: middle;" colspan="2">
                    <%=GetLocaleResourceString("Account.RecoverPasswordInstruction")%>
                </td>
            </tr>
            <tr>
                <td style="text-align: left; vertical-align: middle;" colspan="2">
            ...
            <tr>
                <td style="width: 223px; text-align: right; vertical-align: middle;">
            ...
            <tr>
                ...
                <td style="text-align: left; vertical-align: middle;">
                    <asp:Button runat="server" ID="btnPasswordRecovery" Text="<% $NopResources:Account.PasswordRecovery.RecoverButton %>"
                        ValidationGroup="PasswordRecovery" OnClick="btnPasswordRecovery_Click"></asp:Button>
                </td>
            </tr>
        </table>
    </div>
    <div runat="server" id="pnlNewPassword">
        <table>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtConfirmNewPassword" runat="server" TextMode="Password" Width="150px"></asp:TextBox>
            ...
            <tr>
                ...
                <td style="text-align: left; vertical-align: middle;">
                    <asp:Button runat="server" ID="btnNewPassword" Text="<% $NopResources:Account.PasswordRecovery.NewPasswordSubmit %>"
                        ValidationGroup="NewPassword" OnClick="btnNewPassword_Click"></asp:Button>
                </td>
            </tr>
        </table>
    </div>
