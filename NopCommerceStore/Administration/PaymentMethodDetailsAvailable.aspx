<%@ Page Language="C#" MasterPageFile="~/Administration/main.master" AutoEventWireup="true"
    Inherits="NopSolutions.NopCommerce.Web.Administration.Administration_PaymentMethodDetailsAvailable"
    CodeBehind="PaymentMethodDetailsAvailable.aspx.cs" %>
...
<asp:Content ID="c1" ContentPlaceHolderID="cph1" runat="Server">
    <div class="section-header">
        <div class="title">
            ...
            <a href="PaymentMethodsAvailable.aspx" title="<%=GetLocaleResourceString("Admin.PaymentMethodDetails.BackToMethodList")%>">
