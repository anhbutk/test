...
<ajaxToolkit:TabContainer runat="server" ID="OrderTabs" ActiveTabIndex="0">
    <ajaxToolkit:TabPanel runat="server" ID="pnlOrderInfo" HeaderText="<% $NopResources:Admin.OrderDetails.OrderInfo %>">
        <ContentTemplate>
            <table class="adminContent">
                ...
                <tr runat="server" id="divAffiliate" style="display:none">
                    <td class="adminTitle">
                ...
                <tr runat="server" id="pnlOrderSubtotalInclTax" style="display:none">
                    <td class="adminTitle">
                ...
                <tr runat="server" id="pnlOrderSubtotalExclTax" style="display:none">
                    <td class="adminTitle">
                ...
                <tr runat="server" id="pnlOrderShippingInclTax" style="display:none">
                    <td class="adminTitle">
                ...
                <tr runat="server" id="pnlOrderShippingExclTax" style="display:none">
                    <td class="adminTitle">
                ...
                <tr runat="server" id="pnlPaymentMethodAdditionalFeeExclTax" style="display:none">
                    <td class="adminTitle">
                ...
                <tr>
                 ...
                 <tr>
                    <td class="adminTitle">
                        <nopCommerce:ToolTipLabel runat="server" ID="lblCustomerNoteTitle" Text="Customer Note"
                            ToolTip="Customer Note" ToolTipImage="~/Administration/Common/ico-help.gif" />
                    </td>
                    <td class="adminData">
                        <asp:Label ID="lblCustomerNote" runat="server"></asp:Label>
                    </td>
                </tr>
            </table>
        </ContentTemplate>
    ...
    <ajaxToolkit:TabPanel runat="server" ID="pnlOrderShippingInfo" HeaderText="<% $NopResources:Admin.OrderDetails.ShippingInfo %>">
        <ContentTemplate>
            <table class="adminContent">
                ...
                <tr runat="server" id="divShippingWeight" style="display:none">
                    <td class="adminTitle">
                ...
                <tr runat="server" id="divShippingMethod" style="display:none">
                    <td class="adminTitle">
                        ...
                        <asp:GridView ID="gvOrderProductVariants" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="<% $NopResources:Admin.OrderDetails.Products.Name %>"
                                 ...
                                 <asp:TemplateField HeaderText="<% $NopResources:Admin.ProductInfo.ProductCode %>"
                                    ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <div style="padding-left: 10px; padding-right: 10px; text-align: left;">                                            
                                                <%#Server.HtmlEncode(GetProductVariantCode(Convert.ToInt32(Eval("ProductVariantID"))))%>                                           
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
    ...
    <ajaxToolkit:TabPanel runat="server" Visible="false" ID="pnlOrderNotes" HeaderText="<% $NopResources:Admin.OrderDetails.OrderNotes %>">
        <ContentTemplate>
            <table class="adminContent">
                <tr>
