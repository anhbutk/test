...
<div class="section-header">
    ...
    <div class="options">
        ...
        <asp:Button Visible="false" runat="server" Text="<% $NopResources:Admin.Orders.ExportXMLButton %>"
        ...
        <asp:Button Visible="false" runat="server" Text="<% $NopResources:Admin.Orders.ExportXLSButton %>"
