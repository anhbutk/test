<%@ Control Language="C#" AutoEventWireup="true" Inherits="NopSolutions.NopCommerce.Web.Administration.Modules.PaymentMethodsAvailableControl"
    CodeBehind="PaymentMethodsAvailable.ascx.cs" %>
...
<asp:GridView ID="gvPaymentMethods" runat="server" AutoGenerateColumns="False" Width="100%">
    <Columns>
        ...
        <asp:TemplateField HeaderText="<% $NopResources:Admin.PaymentMethods.Edit %>" HeaderStyle-HorizontalAlign="Center"
            ...
            <ItemTemplate>
                <a href="PaymentMethodDetailsAvailable.aspx?PaymentMethodID=<%#Eval("PaymentMethodID")%>"
