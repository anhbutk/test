...
<ajaxToolkit:TabContainer runat="server" ID="CategoryTabs" ActiveTabIndex="0">
    ...
    <ajaxToolkit:TabPanel Visible="false" runat="server" ID="pnlCategorySEO" HeaderText="<% $NopResources: Admin.CategoryDetails.SEO%>">
        <ContentTemplate>
    ...
    <ajaxToolkit:TabPanel Visible="false" runat="server" ID="pnlDiscountMappings" HeaderText="<% $NopResources:Admin.CategoryDetails.Discounts %>">
        <ContentTemplate>
