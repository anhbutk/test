...
<table class="adminContent">
    ...
    <tr>
        ...
        <td class="adminData">
            <nopCommerce:SimpleTextBox runat="server" CssClass="adminInput" Width="600px" ID="txtSubject" ErrorMessage="<% $NopResources:Admin.MessageTemplateDetails.Subject.ErrorMessage %>">
