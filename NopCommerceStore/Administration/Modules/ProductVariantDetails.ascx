...
<ajaxToolkit:TabContainer runat="server" ID="ProductVariantTabs" ActiveTabIndex="0">
    ...
    <ajaxToolkit:TabPanel Visible="false" runat="server" ID="pnlTierPrices" HeaderText="<% $NopResources:Admin.ProductVariantDetails.TierPrices %>">
        <ContentTemplate>
            <nopCommerce:ProductVariantTierPrices runat="server" ID="ctrlProductVariantTierPrices" />
        </ContentTemplate>
    </ajaxToolkit:TabPanel>
    <ajaxToolkit:TabPanel Visible="false" runat="server" ID="pnlProductAttributes" HeaderText="<% $NopResources:Admin.ProductVariantDetails.Attributes %>">
        <ContentTemplate>
            <nopCommerce:ProductVariantAttributes runat="server" ID="ctrlProductVariantAttributes" />
        </ContentTemplate>
    </ajaxToolkit:TabPanel>
    <ajaxToolkit:TabPanel Visible="false" runat="server" ID="pnlDiscountMappings" HeaderText="<% $NopResources:Admin.ProductVariantDetails.Discounts %>">
        <ContentTemplate>
