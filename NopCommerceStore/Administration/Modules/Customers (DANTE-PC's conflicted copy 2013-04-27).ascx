...
<div class="section-header">
    ...
    <div class="options">
        ...
        <asp:Button Visible="false" runat="server" Text="<% $NopResources:Admin.Customers.ExportXMLButton.Text %>"
        ...
        <asp:Button Visible="false" runat="server" Text="<% $NopResources:Admin.Customers.ExportXLS.Text %>"
        ...
        <asp:Button Visible="false" runat="server" Text="<% $NopResources:Admin.Customers.ImportXLS.Text %>"
