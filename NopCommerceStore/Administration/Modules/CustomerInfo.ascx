...
<table class="adminContent">
    ...
    <tr runat="server" id="Tr1">
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="ToolTipLabel1" Text="<% $NopResources:Order.SavePoint %>"
                ToolTip="<% $NopResources:Order.SavePoint %>" ToolTipImage="~/Administration/Common/ico-help.gif" />
        </td>
        <td class="adminData">
