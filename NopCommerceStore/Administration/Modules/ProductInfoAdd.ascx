...
<table class="adminContent">
    <tr>
     ...
     <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="lblProductCode" Text="<% $NopResources:Admin.ProductInfo.ProductCode %>"
                ToolTip="<% $NopResources:Admin.ProductInfo.ProductCode.Tooltip %>" ToolTipImage="~/Administration/Common/ico-help.gif" />
        </td>
        <td class="adminData">
            <nopCommerce:SimpleTextBox runat="server" ID="txtProductCode" CssClass="adminInput" ErrorMessage="<% $NopResources:Admin.ProductInfo.ProductCode.ErrorMessage %>">
            </nopCommerce:SimpleTextBox>
        </td>
    </tr>
    <tr>
    ...
    <tr runat="server" id="pnlUseDownloadURL" style="display:none">
        <td class="adminTitle">
    ...
    <tr runat="server" id="pnlDownloadURL" style="display:none">
        <td class="adminTitle">
    ...
    <tr runat="server" id="pnlDownloadFile" style="display:none">
        <td class="adminTitle">
    ...
    <tr runat="server" id="pnlUnlimitedDownloads" style="display:none">
        <td class="adminTitle">
    ...
    <tr runat="server" id="pnlMaxNumberOfDownloads" style="display:none">
        <td class="adminTitle">
        ...
        <td class="adminData">
            <nopCommerce:NumericTextBox runat="server" CssClass="adminInput" ID="txtMaxNumberOfDownloads"
                ...
                MinimumValue="0" MaximumValue="999999999" Value="10" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.MaxNumberOfDownloads.RangeErrorMessage %>">
            </nopCommerce:NumericTextBox>
        </td>
    </tr>
    <tr runat="server" id="pnlHasSampleDownload" style="display:none">
        <td class="adminTitle">
    ...
    <tr runat="server" id="pnlUseSampleDownloadURL" style="display:none">
        <td class="adminTitle">
    ...
    <tr runat="server" id="pnlSampleDownloadURL" style="display:none">
        <td class="adminTitle">
    ...
    <tr runat="server" id="pnlSampleDownloadFile" style="display:none">
        <td class="adminTitle">
    ...
    <tr style="display:none">
        ...
        <td class="adminData">
            <nopCommerce:DecimalTextBox runat="server" CssClass="adminInput" ID="txtAdditionalShippingCharge"
                ...
                MinimumValue="0" MaximumValue="999999999" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.AdditionalShippingCharge.RangeErrorMessage %>">
    ...
    <tr runat="server" id="pnlStockQuantity" style="display:none">
        <td class="adminTitle">
        ...
        <td class="adminData">
            <nopCommerce:NumericTextBox runat="server" CssClass="adminInput" ID="txtStockQuantity"
                ...
                MinimumValue="0" MaximumValue="999999999" Value="10000" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.StockQuantity.RangeErrorMessage %>">
            </nopCommerce:NumericTextBox>
        </td>
    </tr>
    <tr runat="server" id="pnlMinStockQuantity" style="display:none">
        <td class="adminTitle">
        ...
        <td class="adminData">
            <nopCommerce:NumericTextBox runat="server" CssClass="adminInput" ID="txtMinStockQuantity"
                ...
                MinimumValue="0" MaximumValue="999999999" Value="0" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.MinStockQuantity.RangeErrorMessage %>">
            </nopCommerce:NumericTextBox>
        </td>
    </tr>
    <tr runat="server" id="pnlLowStockActivity" style="display:none">
        <td class="adminTitle">
    ...
    <tr runat="server" id="pnlNotifyForQuantityBelow" style="display:none">
        <td class="adminTitle">
        ...
        <td class="adminData">
            <nopCommerce:NumericTextBox runat="server" CssClass="adminInput" ID="txtNotifyForQuantityBelow"
                ...
                MinimumValue="1" MaximumValue="999999999" Value="1" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.NotifyForQuantityBelow.RangeErrorMessage %>">
            </nopCommerce:NumericTextBox>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td class="adminData">
            <nopCommerce:NumericTextBox runat="server" CssClass="adminInput" ID="txtOrderMinimumQuantity"
                ...
                MinimumValue="1" MaximumValue="999999999" Value="1" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.OrderMinimumQuantity.RangeErrorMessage %>">
            </nopCommerce:NumericTextBox>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td class="adminData">
            <nopCommerce:NumericTextBox runat="server" CssClass="adminInput" ID="txtOrderMaximumQuantity"
                ...
                MinimumValue="1" MaximumValue="999999999" Value="10000" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.OrderMaximumQuantity.RangeErrorMessage %>">
            </nopCommerce:NumericTextBox>
        </td>
    </tr>
    <tr style="display:none">
    ...
    <tr>
        ...
        <td class="adminData">
            <nopCommerce:DecimalTextBox runat="server" CssClass="adminInput" ID="txtPrice" Value="0"
                ...
                MinimumValue="0" MaximumValue="999999999" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.Price.RangeErrorMessage %>">
            </nopCommerce:DecimalTextBox>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td class="adminData">
            <nopCommerce:DecimalTextBox runat="server" CssClass="adminInput" ID="txtOldPrice"
                ...
                MinimumValue="0" MaximumValue="999999999" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.OldPrice.RangeErrorMessage %>">
            </nopCommerce:DecimalTextBox>
        </td>
    </tr>
    <tr class="adminGroup" style="display:none">
    ...
    <tr class="adminGroup" style="display:none">
        ...
        <td class="adminData">
            <nopCommerce:DecimalTextBox runat="server" CssClass="adminInput" ID="txtWeight" Value="0"
                ...
                MinimumValue="0" MaximumValue="999999999" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.Weight.RangeErrorMessage %>">
            </nopCommerce:DecimalTextBox>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td class="adminData">
            <nopCommerce:DecimalTextBox runat="server" CssClass="adminInput" ID="txtLength" Value="0"
                ...
                MinimumValue="0" MaximumValue="999999999" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.Length.RangeErrorMessage %>">
            </nopCommerce:DecimalTextBox>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td class="adminData">
            <nopCommerce:DecimalTextBox runat="server" CssClass="adminInput" ID="txtWidth" Value="0"
                ...
                MinimumValue="0" MaximumValue="999999999" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.Width.RangeErrorMessage %>">
            </nopCommerce:DecimalTextBox>
        </td>
    </tr>
    <tr style="display:none">
        ...
        <td class="adminData">
            <nopCommerce:DecimalTextBox runat="server" CssClass="adminInput" ID="txtHeight" Value="0"
                ...
                MinimumValue="0" MaximumValue="999999999" RangeErrorMessage="<% $NopResources:Admin.ProductInfo.Height.RangeErrorMessage %>">
            </nopCommerce:DecimalTextBox>
        </td>
    </tr>
</table>
