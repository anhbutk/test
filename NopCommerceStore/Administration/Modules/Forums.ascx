...
<div class="section-header">
    ...
    <div class="options">
        <input type="button" onclick="location.href='ForumGroupAdd.aspx'" value="<%=GetLocaleResourceString("Admin.Forums.ForumGroupAdd.Text")%>"
            id="btnAddNewForumGroup" class="adminButtonBlue" title="<%=GetLocaleResourceString("Admin.Forums.ForumGroupAdd.Tooltip")%>" style="display:none" />
        ...
        <input type="button" onclick="location.href='ForumTopicAdd.aspx'" value="Add Topic"
            id="Button1" class="adminButtonBlue" title="<%=GetLocaleResourceString("Admin.Forums.ForumGroupAdd.Tooltip")%>"  style="display:none"/>
    </div>
</div>
<p>
</p>
