...
<div class="section-header">
    ...
    <div class="options">
        ...
        <input type="button" onclick="location.href='ForumTopicListReorder.aspx'" value="<%=GetLocaleResourceString("Admin.News.Reorder.Text")%>"
            id="Button1" class="adminButtonBlue" title="<%=GetLocaleResourceString("Admin.News.Reorder.Text")%>" />
    </div>
</div>
<p>
</p>
...
<asp:GridView ID="gvNews" runat="server" AutoGenerateColumns="False" Width="100%"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Video Clip" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="15%"
            ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
                <%#Server.HtmlEncode(Eval("VideoClip").ToString())%>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Views" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="5%"
            ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
                <%#Server.HtmlEncode(Eval("Views").ToString())%>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Home Page" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="10%"
            ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
